...
@ContextConfiguration("classpath:integration/spring/inbound-outbound-gateway.xml")
@DirtiesContext
public class InboundOutboundGatewayIntegration {
    ...
    @Test
    public void inboundOutboundGateway() {
        ...
        Person response = template.requestForObject(person, "person-in-subject", Person.class, 1000000, TimeUnit.MILLISECONDS);
